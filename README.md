# Software Engineering Group Project - Group CR7
...
**GitHub Repository:** [https://github.com/swagattharu55-lab/software-engineering-group-project](https://github.com/swagattharu55-lab/software-engineering-group-project)

## Project Description
This project is a web application developed for the Software Engineering module. The aim of the application is to **minimize food waste** by allowing users to share excess food with others in their local community instead of throwing it away.

Users can list surplus food items they no longer need, and other users can request or collect them. The application focuses on co-operation and community support, rather than financial gain, helping to reduce waste and encourage responsible consumption.

### How the Application Supports Sharing, Exchange, and Community
*   **Sharing & Exchange:** Provides a platform where users can offer surplus food to others who need it.
*   **Building Trust:** By connecting people within a community, the system helps build trust and encourages sustainable behavior.
*   **Community Values:** Promotes community engagement, environmental responsibility, and mutual benefit.
...
*   All members will follow university policies regarding academic integrity and ethical behavior.
...
*   Personal information should not be shared publicly without the user’s consent, and access to data should be restricted to authorized users.
...
*   **Discussion:**
    *   Chose project idea: minimizing food waste
...
*   **Decisions:**
    *   Finalized Sprint 1 documentation
